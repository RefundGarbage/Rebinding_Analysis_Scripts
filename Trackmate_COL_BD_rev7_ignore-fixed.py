...
def main(): 
    ...
    csv_path = 'F:\\MicroscopyTest\\Pr212dataSet\\AnalysisRebindCBCstart100noslow' # csv from trackmate
    rs_path = 'F:\\MicroscopyTest\\Pr212dataSet\\particles_result' # *.tif.RESULT
    mask_path = 'F:\\MicroscopyTest\\Pr212dataSet\\seg' # *.png
    ...
    rebind_distance = 4 # pix, max distance for rebinding tabulation (considered same particle)
